...
Working research that backs this comparison — pricing, biomarker panels, features,
community sentiment, third-party comparisons, and biomarker verification gathered from
each service's public website, app-store listings, and third-party sources. These are
notes (with confidence levels and open questions), not polished prose; the cleaned,
synthesized findings live in the main report (`../report.md`). No personal data is included.
